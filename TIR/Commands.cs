...
namespace TIR
{
    public class Commands
    {
        ...
        public static RoutedUICommand AddEditCargoCommand { get; private set; }
        ...
        static Commands()
        {
            ...
            AddEditCargoCommand = new RoutedUICommand("Add or Edit Cargo", "AddEditCargo", typeof(Commands));
